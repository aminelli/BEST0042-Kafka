...
import com.corso.demo.serializers.SerializerBinCustomer;

import net.datafaker.Faker;

public class ProducerCustomers extends ProducerBase {
    ...
    public void sendMessagesBytes(String topicName, int maxMessages) {
        ...
        // valore
        props.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, StringSerializer.class.getName());
        props.put(ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, SerializerBinCustomer.class.getName());

        // Retries
        props.put(ProducerConfig.RETRIES_CONFIG, 3);

        try (final KafkaProducer<String, Customer2> producer = new KafkaProducer<>(props)) {

            ProducerRecord<String, Customer2> record = null;
